...
public class MemberServiceImp implements MemberService {
	...
	public boolean signup(MemberVO member) {
		...
		if(member.getMe_birthday() == null)
			return false;
		//비밀번호 암호화
		String pass = passwordEncoder.encode(member.getMe_pw());
		member.setMe_pw(pass);
		//회원가입
	...
	private String createRandom(int size) {
		String pattern = "0123456789abcdefghijklmnopqrstuwxyzABCDEFGHIJKLMNOPQRSTUWXYZ";
