...
public class StringEx01 {
	...
	public static void main(String[] args) {
		/* String 클래스는 문자열의 값을 수정할 수 없다(수정할 때 새로운 문자열을 만듬)
		 ...
		 * 						첫번째로 만나는 문자열/문자의 시작 번지, 없는 경우 -1 return
		...
		System.out.println("e의 마지막번지 위치 : "+ str.lastIndexOf("f"));
		 ...
		 * 리터럴 문자열은 리터럴만 모여있는 공간에 할당이 되는데, 같은 리터럴 문자열이 있는 경우
		...
		/* trim() : 시작 문장 앞에있는 공백을 제거하고 마지막 문자 뒤에 있는 공백을 제거함*/
		String str5 = "\n\n     \t안녕 하세요.\n\n";
