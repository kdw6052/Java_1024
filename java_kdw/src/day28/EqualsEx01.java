...
public class EqualsEx01 {
	...
	public static void main(String[] args) {
		...
		Test t= new Test(2,1);
		System.out.println("eqauls : "+t.equals(new Test(2,2)));
		
		/* 리스트.indexOf(비교객체)에서 Object.equals를 호출하는데,
		 * Objects.equals(비교객체, 리스트에서 꺼낸 객체)를 호출하기 때문에
		 * 비교객체.equals(리스트에서 꺼낸 객체로)비교
		 * 아래 indexOf는 Integet.equals(Test객체)를 하기 때문에 -1이 나옴
		 * */
